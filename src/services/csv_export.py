...
def _row_for_item(item: ScrapedData) -> dict:
    ...
    return {
        ...
        "marketing_tools": _join_list(meta, "marketing_tools"),
        "advertising": _join_list(meta, "advertising"),
        "ab_testing": _join_list(meta, "ab_testing"),
        "crm": _join_list(meta, "crm"),
        "cdn": _join_list(meta, "cdn"),
        "hosting": _join_list(meta, "hosting"),
        "widgets": _join_list(meta, "widgets"),
        "ecommerce": _join_list(meta, "ecommerce"),
        "payment_processors": _join_list(meta, "payment_processors"),
        "web_servers": _join_list(meta, "web_servers"),
        "programming_languages": _join_list(meta, "programming_languages"),
        "databases": _join_list(meta, "databases"),
        "security": _join_list(meta, "security"),
        "seo_tools": _join_list(meta, "seo_tools"),
        "build_tools": _join_list(meta, "build_tools"),
        "fonts": _join_list(meta, "fonts"),
        "auth": _join_list(meta, "auth"),
        "monitoring": _join_list(meta, "monitoring"),
        "search": _join_list(meta, "search"),
        "video": _join_list(meta, "video"),
        "maps": _join_list(meta, "maps"),
        "other_technologies": _join_list(meta, "other_technologies"),
