...
class FirecrawlService:
    """Transitionary wrapper that uses native LakeStream services.
    
    This replaces the Firecrawl CLI dependency with native Crawler and Scraper.
    """
    ...
    async def search(
        ...
        *,
        ...
        client = LakeCurrentClient(
            base_url=self._settings.lakecurrent_base_url,
            timeout=self._settings.lakecurrent_timeout
        )
        try:
